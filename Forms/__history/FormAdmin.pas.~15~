...
type
  TfrmAdmin = class(TForm)
    ...
    procedure imgOogMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
  private
...
procedure TfrmAdmin.imgOogMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
